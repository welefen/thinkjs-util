...
//Promise
utils.Promise = require('es6-promise').Promise;
 ...
 */
utils.isIP = net.isIP;
utils.isIP4 = net.isIP4;
utils.isIP6 = net.isIP6;
/**
 * 是否是个文件
 * @param  {[type]}  p [description]
 * @return {Boolean}   [description]
 */
utils.isFile = function(p){
	"use strict";
	if (!fs.existsSync(p)) {
		return false;
	}
...
utils.isNumberString = function(obj){
	"use strict";
 ...
 * @return {[type]}      [description]
 */
utils.getFileContent = function(file){
	"use strict";
 ...
 * @return {[type]}      [description]
 */
utils.setFileContent = function(file, data){
	"use strict";
 ...
 * @return {[type]}     [description]
 */
utils.getPromise = function(obj, reject){
	"use strict";
	if (isPromise(obj)) {
		return obj;
	}
 ...
 * @return {[type]}       [description]
 */
utils.getObject = function(key, value){
	"use strict";
	var obj = {};
	if (!isArray(key)) {
		obj[key] = value;
